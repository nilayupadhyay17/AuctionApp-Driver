...
import com.upadhyay.nilay.driver.backend.EndpointsAsyncTask;
...
public class PlaceBid extends Fragment {
    ...
    private EditText bidValue,pickup,drop,currLocation;
    private TextView name,id,time;
    View line,line1;
    ImageView background;
    String userName,auctionID,auctionName,type,regID, endTime;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currLocation = (EditText) view.findViewById(R.id.currLocation);
      ...
      //  id =(TextView) view.findViewById(R.id.ID);
       ...
       // line1 = view.findViewById(R.id.line1);
        ...
        time.setText(val);
       // toolbar.setTitle(auctionName.toString());
    ...
    private String getTimePassed(String time) {
        ...
        String ct =String.format("%02d Minutes and %02d Seconds left",
...
//        Date date = new Date(currTime);
    ...
    private void startAsyncTask() {
       // new EndpointsAsyncTask(getActivity()).execute(Integer.parseInt(bidValue.getText().toString()));
        ...
        endpointAsyncTask.execute(auctionID,auctionName,userName,bidValue.getText().toString(),type,regID,currLocation.getText().toString());
    }
